        ...
        <div className='max-w-sm border p-8 shadow-lg rounded-lg mx-auto bg-white'>
         ...
         <form  onSubmit={handlesubmit} className='space-y-5 max-w-sm mx-auto pt-8' >
          ...
          onChange={
           handleChange}
           name="email"
          type="email" placeholder='Enter Email addrress'
          ...
          ></input>
          <button
          className='w-full mt-5  font-medium  bg-red-500 hover:bg-red-700  px-5 py-3 rounded-md text-white'
          >Submit</button>
         </form>
         <p className='my-5 italic text-sm text-center'>Don't Have an account?<Link className="ml-2 text-sm text-blue-700" to="/register">Register</Link> Here.</p>
        </div>
    </div>
  )
}798
