      ...
      <nav className="flex justify-between items-center h-full">
        ...
        <div className=" hidden md:flex items-center gap-6 text-xl text-gray-700">
          <span>
            <Link to="/search">
              {" "}
              <i className=" hover:text-blue-600 transition duration-300 fa-solid fa-magnifying-glass"></i>
            </Link>
          </span>
          <span>
            <button
            ...
            >
              ...
              <sup className="text-sm text-white rounded-full bg-red-500 px-1.5 inline-block text-center">
                {cartItems.length}
              </sup>
            </button>
          </span>
